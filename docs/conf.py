...
project = u'wechatpy'
copyright = u'2014 - 2017, Messense Lv'
...
latex_documents = [
  ('index', 'wechatpy.tex', u'wechatpy Documentation',
   u'messense', 'manual'),
]
...
man_pages = [
    ('index', 'wechatpy', u'wechatpy Documentation',
     [u'messense'], 1)
]
...
texinfo_documents = [
  ('index', 'wechatpy', u'wechatpy Documentation',
   u'messense', 'wechatpy', 'One line description of project.',
   'Miscellaneous'),
]
