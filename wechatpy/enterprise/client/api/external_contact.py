...
class WechatExternalContact(BaseWeChatAPI):
    ...
    def get(self, external_userid: str):
        """
        获取外部联系人详情
    ...
    def add_contact_way(self, type: int, scene: int, style: int=None,
                        remark: str=None, skip_verify=True, state: str=None,
                        user=None, party: list=None):
        """
        配置客户联系「联系我」方式
        ...
        :param userid: 使用该联系方式的用户userID列表，在type为1时为必填，且只能有一个
    ...
    def get_contact_way(self, config_id: str):
        """
        获取企业已配置的「联系我」方式
        https://work.weixin.qq.com/api/doc#90000/90135/91559
    ...
    def update_contact_way(self, config_id: str, remark: str, skip_verify=True,
                           style: int=None, state: str=None, user=None,
                           party: list=None):
        """
        更新企业已配置的「联系我」方式
        https://work.weixin.qq.com/api/doc#90000/90135/91559
    ...
    def add_msg_template(self, template: dict):
        """
        添加企业群发消息模板
    ...
    def get_group_msg_result(self, msgid: str):
        """
        获取企业群发消息发送结果
    ...
    def get_user_behavior_data(self, userid: list,
    ...
    def send_welcome_msg(self, template: dict):
        """
        发送新客户欢迎语
    ...
    def get_unassigned_list(self, page_id: int, page_size: int):
        """
        获取离职成员的客户列表
    ...
    def transfer(self, external_userid: str, handover_userid: str,
                 takeover_userid: str):
        """
        离职成员的外部联系人再分配
